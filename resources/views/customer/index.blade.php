                                ...
                                <table class="table table-hover" id="bars">
                                    ...
                                    <tbody>
                                      @foreach ($data_customer as $customer)
                                        <tr>
                                            <td></td>
                                            <td scope="row">{{ $customer->nama_pt }}</td>
                                            <td scope="row">{{ $customer->nama_agent }}</td>
                                            <td scope="row">{{ $customer->alamat }}</td>
                                            <td scope="row">{{ $customer->kota }}</td>
                                            <td scope="row">{{ $customer->email }}</td>
                                            <td scope="row">{{ $customer->no_telp }}</td>
                                            <td scope="row"><a href="/customer/{{ $customer->id }}/edit" class="btn btn-warning btn-sm"><i class="fa fa-pencil"></i> Edit</a>
                                              &nbsp;&nbsp;&nbsp;
                                              <a href="#" class="btn btn-danger btn-sm delete" data-id="{{ $customer->id }}" data-nama="{{ $customer->nama_pt }}"><i class="fa fa-trash-o"></i> Delete</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
